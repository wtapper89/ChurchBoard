...
async function loadSettings(){
  ...
  const pc=settings.planning_center||{},pp=settings.propresenter||{},sh=settings.shure||{},se=settings.sennheiser||{},osm=settings.open_sound_meter||{},restream=settings.restream||{},obs=settings.obs||{},server=settings.server||{},live=pc.live_from_propresenter||{};
  ...
  sf.server_port.value=Number(server.port)||8040;sf.https_enabled.checked=!!server.https_enabled;sf.ssl_certfile.value=server.ssl_certfile||"";sf.ssl_keyfile.value=server.ssl_keyfile||"";
