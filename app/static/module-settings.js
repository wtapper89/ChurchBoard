...
function moduleConfigurationMarkup(module){
  ...
  if(id==="prodmesh-rta")return `${toggle("Enable ProdMesh Remote RTA","prodmesh_rta.enabled")}<div class="module-form-columns">${field("ProdMesh computer address","prodmesh_rta.host",{placeholder:"192.168.1.75"})}${field("API port","prodmesh_rta.port",{type:"number",min:1,max:65535,fallback:8517})}</div><div class="module-inline-actions"><button class="button secondary" type="button" data-module-test="prodmesh">Save &amp; test connection</button></div><p class="hint">Enable <strong>Settings → API &amp; Streaming</strong> in ProdMesh Remote RTA first.</p>`;
